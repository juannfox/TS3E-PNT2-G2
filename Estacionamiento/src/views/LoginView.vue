  ...
  <ion-page>
    <ion-content>
      <div class="contenedor">
        <ion-card class="carta" color="light">
          <ion-segment color="primary" :value="segmentoLogin" @ion-change="segmentChanged">
          ...
          <ion-item v-show="segmentoLogin === 'login'" color="light">
          ...
          <ion-item v-show="segmentoLogin === 'registrar'" color="light">
            <form v-if="!loggedIn" class="cardRegistrar">
              <ion-item style="width:100%" color="light">
              ...
              <ion-item style="width:100%" color="light">
                <ion-text postion="floating">Contraseña: </ion-text>
                <ion-input type="password" v-model="registroInput.password" style="margin-left:10px;"
                  required></ion-input>
              </ion-item>
              <ion-item style="width:100%" color="light">
                <ion-text postion="floating">Confirmar contraseña: </ion-text>
                <ion-input type="password" v-model="registroInput.confirmPassword" style="margin-left:10px;"
                  required></ion-input>
              </ion-item>
...
//Placeholder
const ventanaRegistrar = ref(false)
const segmentoLogin = ref("login")
const usuarioInput = { email: "", password: "" };
const registroInput = { nombre: "", email: "", password: "", confirmPassword: "" };

function toggleVentanaRegistrar() {
  ventanaRegistrar.value = !ventanaRegistrar.value
}

function segmentChanged(event) {
    segmentoLogin.value = event.detail.value
}
